...
def inqRandomNews():
    ...
    print(['xxx','currRatio',currRatio,'ratioNew',ratioNew,'currPage: ',currPage,' limitPages: ',limitPages,' new Limit: ', newLimit])  
...
###while (i<50):    
  ...
  #time.sleep(200) # unless drop none-french
  #time.sleep(20)
  termsDF = termsDF.sort_values(by=['ratioNew'], ascending=False)
  termsDF.to_csv(DATA_PATH / 'keywords.csv', columns=keywordsFields,index=False) 
  time.sleep(1000)
'''    
